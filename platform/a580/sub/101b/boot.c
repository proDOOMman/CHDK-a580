...
void __attribute__((naked,noinline)) CreateTask_Startup_my() { //#fs
        ...
        "loc_FFC0CDB4:\n"
                ...
                "BL      sub_FFC17B24\n"
                //different from a720!!!
                "LDR     R1, =0x2CE000\n"// там вверху про 0x300000 что-то было...
                "MOV     R0, #0\n"
                "BL      sub_FFC17D6C\n"
                "BL      sub_FFC17D18\n"
                "MOV     R3, #0\n"
...
void __attribute__((naked,noinline)) task_Startup_my() { //#fs
        asm volatile (
                ...
                //"BL      j_nullsub_217\n"
                "BL      sub_FFC199A4\n"
                //"BL      sub_FFC19864\n"  // StartDiskboot //TODO: comment!
        );

        CreateTask_spytask(); //TODO: uncomment!
...
/////вверху все работает (кроме createTask)
...
void __attribute__((naked,noinline)) sub_FFC1A4C0_my() { //#fs
        debugLed();
        asm volatile (
                "STMFD   SP!, {R4,LR}\n"
                "BL      sub_FFC5D254\n"
...
//UP!
void __attribute__((naked,noinline)) sub_FFC1A090_my() { //#fs
        asm volatile (
                "B sub_FFC1C294\n" // test: branch to original function//TODO: comment!
                "STMFD   SP!, {R3-R11,LR}\n"
                "LDR     R6, =0x1DCC\n"
                "MOV     R5, R3\n"
                "LDR     R0, [R6,#0x14]\n"
